...
citySelector.hotCity = ["北京", "上海", "苏州", "南京"];
...
citySelector.template = '<div class="city-box" id="js_cityBox"><div id="closeD" class="close_css"><span id="closeA" class="icon"></span></div><div class="prov-city" id="js_provCity"><p>热门城市</p><ul>' + citySelector.hotCityhtmls + '</ul></div><div class="provence"><div>选择省份</div><div><ul id="js_provList">' + citySelector.provHtmls + '</ul></div></div></div>';
